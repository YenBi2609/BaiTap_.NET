...
namespace _11185711_QuachThiYen_3 {
    ...
    public class BAOCAO_TAISAN : ReportClass {
        
        public BAOCAO_TAISAN() {
        }
        
        public override string ResourceName {
            get {
                return "BAOCAO_TAISAN.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "_11185711_QuachThiYen_3.BAOCAO_TAISAN.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBAOCAO_TAISAN : Component, ICachedReport {
        
        public CachedBAOCAO_TAISAN() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BAOCAO_TAISAN rpt = new BAOCAO_TAISAN();
            rpt.Site = this.Site;
            return rpt;
        }
