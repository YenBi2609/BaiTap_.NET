...
namespace QuachThiYen_2105 {
    ...
    public class BAOCAO_PHONGBAN : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "QuachThiYen_2105.BAOCAO_PHONGBAN.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBAOCAO_PHONGBAN : Component, ICachedReport {
        
        public CachedBAOCAO_PHONGBAN() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BAOCAO_PHONGBAN rpt = new BAOCAO_PHONGBAN();
            rpt.Site = this.Site;
            return rpt;
        }
